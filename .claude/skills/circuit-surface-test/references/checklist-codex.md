...
CLI: `run explore --process high --goal 'compare small vs broad investigation'`
...
CLI: `run fix --process low --goal 'a README typo - change "fixture" to "fixtures"'`
...
CLI: `run build --process low --goal 'export TWO = 2 from add.js'`
