...
| Working strategy | [docs/ideas/positioning-and-strategy.md](ideas/positioning-and-strategy.md) | Point-in-time workshop notes from May 2026. Superseded for current claims by [docs/positioning.md](positioning.md); validate against code and release evidence before reuse. |
