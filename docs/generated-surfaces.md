...
| `pursue` | `public` | `src/flows/pursue/data.ts`<br>`src/flows/pursue/flow.ts`<br>generates `src/flows/pursue/schematic.json` | `generated/flows/pursue/circuit.json`<br>`generated/flows/pursue/circuit.work-contract.v0.json` | `plugins/claude/skills/pursue/circuit.json`<br>`plugins/codex/flows/pursue/circuit.json` | `src/flows/pursue/command.md` | `plugins/claude/commands/pursue.md`<br>`plugins/codex/commands/pursue.md`<br>`plugins/codex/skills/pursue/SKILL.md` | Edit the flow package source; run `npm run emit-flows`. |
...
| `explainer` | `public` | `src/flows/explainer/data.ts`<br>`src/flows/explainer/flow.ts`<br>generates `src/flows/explainer/schematic.json` | `generated/flows/explainer/circuit.json`<br>`generated/flows/explainer/circuit.work-contract.v0.json` | `plugins/claude/skills/explainer/circuit.json`<br>`plugins/codex/flows/explainer/circuit.json` | none | none | Edit the flow package; run `npm run emit-flows`. |
