...
| [`equipment-scope-build-brief.md`](equipment-scope-build-brief.md) | `partially-implemented` | Build brief for the equipment-scope mechanism (declared tools sub-axis + write-tier enforcement). Increment 1 (declared + trusted provide) implemented on feat/equipment-scope; write-tier enforcement is the open increment. |
