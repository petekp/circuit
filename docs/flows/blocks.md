...
| Goal | Turn a user objective into a bounded contract with proof, recovery, and completion-gate policy. | Intake, route decision. | Goal contract with done claims, allowed flow targets, and gate policy. | Continue, Human Decision, Stop. |
