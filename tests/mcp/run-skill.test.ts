...
describe('Codex MCP Run skill', () => {
  ...
  it('teaches the complete six-tool lifecycle without a shell fallback', () => {
    ...
    // get right: consent to relay tracked code, one pinned target, keep a path
    // narrowing instead of widening it, and no pull-request fetch. Pinning
    // every sentence of the section made ordinary rewording a test failure
