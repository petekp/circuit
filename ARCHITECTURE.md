...
This document explains the design of the method system: why it exists, how its
...
The method system solves a specific problem: **how do you make an AI agent
...
The central design insight of the method system is: **artifacts are the durable
...
1. `METHOD_PLUGIN_SKILL_DIR` environment variable (for testing)
