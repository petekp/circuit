#!/usr/bin/env node
// Node-floor shim for the Claude Stop / SessionEnd / PreCompact hook.
//
// The real hook is harvest.ts. A host that runs `node harvest.ts` on a Node
