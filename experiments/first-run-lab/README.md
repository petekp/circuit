...
README verbatim. The goal is confidence in the first-run experience before the
v1 announcement, and a repeatable place to re-prove it later.
...
what a user gets right now, not the local working tree.
