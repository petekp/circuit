...
name: method:router
description: >
  Routes `/method:router` requests to the best-fit method skill among the 8
...
- Cleanup-only scope: `method:janitor` instead of `method:autonomous-ratchet` (ratchet is for quality improvement, janitor is for removal).
