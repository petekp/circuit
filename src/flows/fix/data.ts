  ...
  runtimeSurface: {
    ...
    progress: {
      steps: [
        ...
        {
          stepId: 'fix-diagnose',
          taskTitle: 'Diagnose the cause',
          activeText: 'Diagnosing the cause',
          relayRole: 'researcher',
        ...
        },
        {
          ...
          taskTitle: 'Confirm the bug reproduces',
          activeText: 'Confirming the bug reproduces',
        },
        {
          stepId: 'fix-regression-baseline',
          taskTitle: 'Capture the failing test',
          activeText: 'Capturing the failing test',
        },
        {
          stepId: 'fix-baseline-snapshot',
          taskTitle: 'Record the starting state',
          activeText: 'Recording the starting state',
        },
        {
          stepId: 'fix-act',
        ...
        {
          stepId: 'fix-verify',
          taskTitle: 'Verify the fix',
          activeText: 'Verifying the fix',
        },
        {
          stepId: 'fix-change-set',
          taskTitle: 'Check the changed files',
          activeText: 'Checking the changed files',
        },
        {
          stepId: 'fix-regression-rerun',
          taskTitle: 'Rerun the failing test',
          activeText: 'Rerunning the failing test',
        },
        {
          stepId: 'fix-review',
